...
(function () {
  ...
  var 답들 = [
    ...
    },
    {
      키: '사는법',
      물음: '어떻게 사나요?',
      말: ['사는', '구매', '결제', '카드', '주문', '어떻게 사', '살 수'],
      답: [
        ['① 도구를 고릅니다', '첫 쪽 도구 선반에서 「데려가기」를 누르시면 결제창이 열립니다.'],
        ['② 카드로 냅니다', '국내 카드도 해외 카드도 됩니다.'],
        ['③ 정품 이름표가 편지로 옵니다',
  ...
  var 첫단추 = ['고르기', '값', '구독', '인터넷', '사는법', '책', '무료', '환불'];
